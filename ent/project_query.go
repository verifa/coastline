...
func (pq *ProjectQuery) loadRequests(ctx context.Context, query *RequestQuery, nodes []*Project, init func(*Project), assign func(*Project, *Request)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(project.RequestsTable)
		s.Join(joinT).On(s.C(request.FieldID), joinT.C(project.RequestsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(project.RequestsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(project.RequestsPrimaryKey[1]))
